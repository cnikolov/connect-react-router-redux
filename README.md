> Breaking change in v5.0.0! Please read [How to migrate from v4 to v5/v6](https://github.com/cnikolov/connect-react-router-redux/blob/master/FAQ.md#how-to-migrate-from-v4-to-v5v6).
